 ...
 * @returns {string} The complete base URL including protocol, host, port, and /api/v1 prefix (no trailing slash)
 */
export const getApiBaseURL = () => {
  ...
  try {
    ...
    // Step 5: Construct final URL - origin + /api/v1 (NO trailing slash)
